...
class MakananTerakhir extends StatefulWidget {
  const MakananTerakhir({super.key});

  @override
  State<MakananTerakhir> createState() => _MakananTerakhirState();
}

class _MakananTerakhirState extends State<MakananTerakhir> {
  @override
